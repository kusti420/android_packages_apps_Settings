...
public class AppVersionPreferenceController extends AppInfoPreferenceControllerBase {
    ...
    public CharSequence getSummary() {
        ...
        final CharSequence version = mContext.getString(R.string.version_text,
                BidiFormatter.getInstance().unicodeWrap(packageInfo.versionName));
        // IchthysOS: append the package name on a second footer line, under the version.
        // AppVersionFooterPreference makes this summary multi-line so it isn't clipped.
