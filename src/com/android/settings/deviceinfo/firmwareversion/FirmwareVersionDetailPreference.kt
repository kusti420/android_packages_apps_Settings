...
class FirmwareVersionDetailPreference :
    ...
    // IchthysOS: this SPA composable is the live renderer for the Android version row; the classic
    // FirmwareVersionDetailPreferenceController.getSummary() is dead code here. Append the API
    // marketing name so it reads e.g. "Baklava (Android 17)".
    override fun getSummary(context: Context): CharSequence? =
        Build.VERSION.RELEASE_OR_PREVIEW_DISPLAY + " (Android 17)"
