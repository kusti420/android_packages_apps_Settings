...
private fun AppInfoSettings(packageInfoPresenter: PackageInfoPresenter) {
    ...
    RegularScaffold(
        ...
        // IchthysOS: always show the package name under the version in the App info footer,
        // not only when Developer options are enabled (the SPA default gates it behind
        // rememberIsDevelopmentSettingsEnabled()). This SPA/Compose footer is what actually
        // renders the App info version line, NOT the classic AppVersionPreferenceController.
